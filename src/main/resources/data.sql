...
INSERT INTO excursions (identifier, exhibit_id, visitor_id, date, guide) VALUES
  ('c1d2e3f4-a5b6-7890-abcd-ef1234567801',
   'a1b2c3d4-e5f6-7890-abcd-ef1234567801',
   'b1c2d3e4-f5a6-7890-abcd-ef1234567801',
   CURRENT_DATE, 'Козлов Дмитрий'),
  ('c1d2e3f4-a5b6-7890-abcd-ef1234567802',
   'a1b2c3d4-e5f6-7890-abcd-ef1234567802',
   'b1c2d3e4-f5a6-7890-abcd-ef1234567802',
   CURRENT_DATE, 'Николаева Анна'),
  ('c1d2e3f4-a5b6-7890-abcd-ef1234567803',
   'a1b2c3d4-e5f6-7890-abcd-ef1234567803',
   'b1c2d3e4-f5a6-7890-abcd-ef1234567803',
   CURRENT_DATE, 'Козлов Дмитрий')
ON CONFLICT DO NOTHING;